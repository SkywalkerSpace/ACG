...
class Gr00tPolicy(BasePolicy):
    ...
    def __init__(
        ...
        # Load transforms
        if metadata_dict is not None:  # (modified) use metadata_dict if available
    ...
    def get_action(self, observations: Dict[str, Any], *args, **kwargs) -> Dict[str, Any]:
        """
    ...
    def _load_model(self, model_path):
        model = GR00T_N1.from_pretrained(model_path, torch_dtype=COMPUTE_DTYPE, ignore_mismatched_sizes=False)
